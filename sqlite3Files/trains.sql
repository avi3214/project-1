...
CREATE TABLE booked(SSN text not null, train_number integer not null, ticket_type text not null, status text not null);
...
CREATE TABLE status(date text, train_name text, premium_available int, gen_available int, premium_taken int, gen_taken int);
